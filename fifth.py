...
# Membuat plot untuk setiap puncak dengan zoom dan menghitung luas kurva
...
for peak in peaks:
    ...
    # Menghitung luas kurva menggunakan metode trapezoid
    area = trapz(corrected_intensities[start:end], wavelengths[start:end])
    ...
    plt.savefig(f'peak_{wavelengths[peak]:.2f}_nm_zoome11d.pdf', format='pdf', dpi=300)  # dpi menentukan resolusi
